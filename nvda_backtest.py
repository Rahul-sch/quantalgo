#!/usr/bin/env python3
"""
NVDA FVG Continuation Backtest — Using same model as QQQ
Tests the FVG continuation + break-even at IRL strategy on NVDA 1h data.
"""
import sys, os
import pandas as pd
import numpy as np
...
DATA = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data', 'NVDA_1h_2yr.csv')
...
def main():
    print(f"\n{'=' * 65}")
    print(f"  📊 NVDA FVG CONTINUATION — 3-YEAR BACKTEST (1h bars)")
    print(f"{'=' * 65}")
